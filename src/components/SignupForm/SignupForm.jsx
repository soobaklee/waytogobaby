                    ...
                    <table>
                        <tbody>
                            ...
                            <tr className="sform-line">
                                ...
                                <td><input autocomplete="off" type="text" className="sform-input" placeholder="Birthdate" value={moment(this.state.birthdate).format("MM/DD/YYYY")} name="birthdate" onChange={this.handleChange} /></td>
                            </tr>
                            {/* <tr className="sform-line">
                            ...
                            <tr className="form-btn-line">
                                <td></td>
                                <td><button className="submit-btn" disabled={this.isFormInvalid()}>Sign Up</button>&nbsp;
